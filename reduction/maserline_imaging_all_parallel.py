...
#siov1clean(['../'+x for x in Qmses], name='18A-229_combined', threshold='25mJy', parallel=True)
#siov2clean(['../'+x for x in Qmses], name='18A-229_combined', threshold='25mJy', parallel=True)
#ch3ohmaserclean(['../'+x for x in Qmses], name='18A-229_combined', threshold='25mJy', parallel=True)
#ch3ohthermalclean(['../'+x for x in Qmses], name='18A-229_combined', threshold='25mJy', parallel=True)

...
nh374clean(['../'+x for x in Kmses], name='18A-229_combined', threshold='25mJy')
nh362clean(['../'+x for x in Kmses], name='18A-229_combined', threshold='25mJy')
nh398clean(['../'+x for x in Kmses], name='18A-229_combined', threshold='25mJy')
